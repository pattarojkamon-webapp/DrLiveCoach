...
export const TRANSLATIONS: Record<Language, any> = {
  ...
  TH: {
    ...
    username: "ชื่อผู้ใช้",
    password: "รหัสผ่าน",
    name: "ชื่อที่ใช้แสดง (Display Name)",
    loginBtn: "เข้าสู่ระบบ",
    signupBtn: "สมัครสมาชิก",
    switchLogin: "มีบัญชีอยู่แล้ว? เข้าสู่ระบบ",
    switchSignup: "ยังไม่มีบัญชี? สมัครสมาชิก",
    guideBtn: "คู่มือการใช้งาน",
    logout: "ออกจากระบบ",
    welcome: "ยินดีต้อนรับ",
    fillAllFields: "กรุณากรอกข้อมูลให้ครบถ้วน",
    authFailed: "เข้าสู่ระบบไม่สำเร็จ โปรดตรวจสอบชื่อผู้ใช้หรือรหัสผ่าน",
    userExists: "ชื่อผู้ใช้นี้มีอยู่ในระบบแล้ว"
  },
  CN: {
    title: "Dr.LiveCoach",
    subtitle: "专业教练模拟系统",
    ...
    signupBtn: "注册",
    switchLogin: "已有账户？登录",
    switchSignup: "没有账户？注册",
    guideBtn: "使用指南",
    logout: "退出登录",
    welcome: "欢迎",
    fillAllFields: "请填写所有字段",
    authFailed: "验证失败。请检查您的凭据。",
    userExists: "用户名已存在。"
  }
};
