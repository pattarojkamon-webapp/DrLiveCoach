...
export const TRANSLATIONS: Record<Language, any> = {
  EN: {
    ...
    apiKeyDesc: "Enter your API Key to enable AI features.",
  ...
  TH: {
    ...
    apiKeyLabel: "Google Gemini API Key",
    apiKeyDesc: "ใส่ API Key ของคุณเพื่อใช้งาน AI",
    apiKeyPlaceholder: "วาง API Key ที่นี่ (ขึ้นต้นด้วย AIza...)",
    ...
    switchSignup: "ยังไม่มีบัญชี? ลงทะเบียน",
  ...
  CN: {
    ...
    settings: "设置",
    apiKeyLabel: "Google Gemini API Key",
    apiKeyDesc: "输入您的 API Key 以启用 AI 功能。",
    apiKeyPlaceholder: "在此粘贴您的 API Key (以 AIza 开头...)",
    saveBtn: "保存设置",
